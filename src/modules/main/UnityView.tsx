...
const UnityView = (props: UnityViewProps): JSX.Element => {
  ...
  const {
    ...
    loaderUrl: './BuildBoxRace/Build/BuildBoxRace.loader.js',
    dataUrl: './BuildBoxRace/Build/BuildBoxRace.data',
    frameworkUrl: './BuildBoxRace/Build/BuildBoxRace.framework.js',
    codeUrl: './BuildBoxRace/Build/BuildBoxRace.wasm',
  });
